...

{
    ...
    is (charnames::viacode(ord_latin1_to_native(0x80)), "myctrl", "Verify that can name a nameless control");
...

{
    ...
    is(charnames::string_vianame("LATIN SMALL LETTER Y WITH DIAERESIS"), chr(ord_latin1_to_native(0xFF)), "Verify string_vianame(\"LATIN SMALL LETTER Y WITH DIAERESIS\") is chr(native 0xFF) under 'use bytes'");
    cmp_ok($warning_count, '==', scalar @WARN, "Verify string_vianame doesn't warn on legal inputs under 'use bytes'");
...
my $three_quarters = sprintf("%2X", ord_latin1_to_native(0xBE));
...

{
    ...
    while (<$fh>) {
        ...
        my $decimal = ord_latin1_to_native(hex $code);
        ...
        $name = 'ALERT' if $decimal == ord_latin1_to_native(7);
    ...
    while ($block < $block_count) {
        ...
        for (1 .. $test_count) {
            ...
            if (! $names[$i]) {
                ...
                next if $i == ord_latin1_to_native(0x80)
                              || $i == ord_latin1_to_native(0x81)
                              || $i == ord_latin1_to_native(0x84)
                              || $i == ord_latin1_to_native(0x99);
                ...
                if ($i != ord_latin1_to_native(0x0a)
                    && $i != ord_latin1_to_native(0x0c)
                    && $i != ord_latin1_to_native(0x0d)
                    && $i != ord_latin1_to_native(0x85))
                {
